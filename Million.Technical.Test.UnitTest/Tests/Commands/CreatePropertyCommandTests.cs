...
namespace Million.Technical.Test.UnitTests.Commands
{
    ...
    public class CreatePropertyCommandTests
    {
        ...
        [TestCase("", "Address required")]
        [TestCase("12", "Address too short")]
        [TestCase("A", 251, "Address too long")] 
        ...
        [Test]
        public async Task Handler_WhenOwnerDoesNotExist_ShouldThrowNotFoundException()
        {
            var command = new CreatePropertyCommand
            {
                Name = "Test Property",
